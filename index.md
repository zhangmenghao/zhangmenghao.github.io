...
* **Research interest**: 
    ...
    - High-Performance Networking. Recently I am working on the area of high-performance networking (e.g., RDMA, SmartNIC, DPU/IPU, DPDK) in large-scale real-world data center scenarios, especially large-scale distributed machine learning clusters.
...
In IEEE Transactions on Parallel and Distributed Systems (**<font color='red'>TPDS</font>**), vol. 33, no. 10, October 2022 (*CCF-A/TH-CPL-A, <font color='red'>SCI Impact Factor 2.687</font>*, *<font color='red'>top journal in High Performance Computing</font>*) [[code](https://github.com/netec-2019/netec)]
...
## Patents
* 徐明伟,郭诚,李冠宇,张梦豪,王士诚,李琦. 流量特征提取方法、系统、存储介质及电子设备[P]. 202111322171.2, 2021-11-09.
* 徐明伟,张梦豪,李冠宇,曹家浩. 深度报文检测系统及其检测方法、计算机设备和存储介质[P]. 202110637419.8, 2021-06-08.
