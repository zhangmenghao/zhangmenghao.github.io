...
* **Research interest**: 
    ...
    - High-Performance Networking. I am also working on the area of high-performance networking (e.g., RDMA, SmartNIC, DPU/IPU, NCCL) and communication optimizations in large-scale distributed machine learning clusters, which is becoming more and more important in this AI era. I have fortunately experienced the design, optimization and practice of RDMA network in Kuaishou's machine learning clusters from scratch, which give me production-level engineering experiences and invaluable industrial perspectives.
